...
테라폼은 인프라를 수정하기 전에 플랜을 생성하고 승인을 받도록 되어 있습니다. 또한 실제 인프라를 상태 파일로 추적할 수 있습니다. 상태 파일은 여러분이 만든 환경 그 자체를 보여줍니다. 테라폼은 여러분의 환경 구성에 일치시키기 위해 상태 파일로 하여금 여러분의 인프라를 어떻게 변경할지 결정합니다.
